...
export const cards = [
    ...
    {
        id: 2,
        iconSrc: `${process.env.PUBLIC_URL}/images/icon-security.svg`,
    ...
    {
        id: 3,
        iconSrc: `${process.env.PUBLIC_URL}/images/icon-collaboration.svg`,
    ...
    {
        id: 4,
        iconSrc: `${process.env.PUBLIC_URL}/images/icon-any-file.svg`,
